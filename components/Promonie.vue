<template>
  <div class="promonie">
    <div class="promonie__inner">
      <div class="promonie__inner__content">
        <div class="announcement__badge">
          <span>New</span>
          <NuxtLink to="/" class="announcement__badge__link">
            Introducing Promonie
      ...
      <div class="promonie__inner__image">
        <NuxtImg src="/img/promonie-preview.png" alt="Promonie" />
      </div>
