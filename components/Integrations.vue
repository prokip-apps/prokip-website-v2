  ...
  <div class="integrations">
    <div class="integrations__inner">
      ...
      <div class="integrations__inner__logos">
        ...
        <div class="integrations__inner__logos__item">
          <img src="/img/woocommerce-logo.png" alt="WooCommerce" />
        </div>

        <div class="integrations__inner__logos__item">
          <img src="/img/shopify-logo.png" alt="Shopify" />
        </div>

        <div class="integrations__inner__logos__item">
          <img src="/img/mpesa-logo.png" alt="Mpesa" />
        </div>

        <div class="integrations__inner__logos__item">
          <img src="/img/fluentCRM-logo.png" alt="FluentCRM" />
        </div>

        <div class="integrations__inner__logos__item">
          <img src="/img/Mailchimp-logo.png" alt="Mailchimp" />
        </div>
      </div>
